...
export default function checkNumber(n) {
  ...
  if (((sixCount >= 222100 && sixCount <= 272099) || [51, 52, 53, 54, 55].some((e) => card.startsWith(e))) && (card.length === 16)) {
    return 'MasteCard';
  }
  ...
  if (((sixCount >= 622126 && sixCount <= 622925) || [6011, 644, 645, 646, 647, 648, 649, 65].some((e) => card.startsWith(e))) &&
    (card.length >= 16 && card.length <= 19)) {
    return 'Discover';
  }
